...
// ==========================================
// AUTHENTICATION & STORE ENTRY LOGIC
// ==========================================
...
function handleSignup(event) {
  ...
  logDeveloperEvent(`USER ENTERED: ${currentUser.memberId} | ${currentUser.name}`);
}
...
function updateUserUI() {
  const elements = {
    ...
    'sidebar-user-name': currentUser.name,
    'profile-id': currentUser.memberId,
    'profile-name': currentUser.name,
    'profile-contact': currentUser.contact,
    'mudra-gold': currentUser.mudraGold,
    'mudra-silver': currentUser.mudraSilver,
    'profile-mudra': `${currentUser.mudraGold} Gold`,
    'wishlist-count': currentUser.wishlist.length,
    'cart-count': currentUser.cart.length
  };
...
// Single Consolidated Orders Display Function
